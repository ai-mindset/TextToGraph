"""This module exports graph data from a SQLite database to a JSON file in a format
suitable for use with D3.js."""
...
# %%
def export_graph_data(db_path: str = "data/graph_database.sqlite") -> None:
    ...
    edges = [
        {"source": row[0], "target": row[1], "relationship": row[2], "weight": row[3]}
